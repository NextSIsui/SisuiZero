...
public class PlayerExpultionCommand implements CommandExecutor{
    @Override
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
        ...
        if(nationPlayer.getNation().getPeople().contains(nationPlayer1)) return false;

        nationPlayer.getNation().removePeople(nationPlayer1);
        return true;
    }
}
